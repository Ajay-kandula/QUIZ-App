...
const Quiz = () => {
  ...
  return (
    <div  style={{backgroundImage:`url("https://i.ibb.co/WvDS0xQd/iz-compressed.webp")`,backgroundPosition:"center",backgroundSize:"cover",height:"100vh",width:'100vw',display:"flex",justifyContent:"flex-start",flexDirection:"column",alignItems:"flex-start"}}>
      <h4 style={{marginLeft:isMobile?"150px":"1050px",marginBottom:isMobile?"10px":"65px",fontSize:isMobile?"15px":"25px"}}>Time Left: {timer}s</h4>
      <div style={{display:"flex", flexDirection:"column",height:isMobile?"30%":"80%",width:isMobile?"35px":"600px",marginLeft:isMobile?"10px":"500px",border:"2px solid grey",fontSize:isMobile?"10px":"20px",borderRadius:"10px"}}>
