...
const Login =()=>{
    ...
    return( 
        <div  style={{display: "flex",flexDirection: "column",alignItems: 'flex-end',justifyContent: 'flex-end',height:"100vh",width:"100vw",backgroundImage:`url(${loginBg})`,backgroundSize:'cover',backgroundPosition:"center",paddingRight:"40px",overflow:'hidden'}} >
