...
const Login =()=>{
    ...
    return( 
        <div style={{display:'flex',justifyContent:"flex-start",flexDirection:"column",minHeight:"100vh",width:"100vw",alignItems:"flex-start",backgroundImage:`url("https://i.ibb.co/QvGWFSXJ/log-compressed.webp")`,backgroundPosition:'center',backgroundSize:"cover"}} >
            <h1 style={{color:"white",marginBottom:"1px",marginLeft:isMobile ? "50px" : "250px",marginTop:isMobile? '250px':"60px",width:isMobile ? "90%" : "40%",fontSize:isMobile ? "24px" : "40px"}}>Login form</h1>
            <div  style={{display:"flex",justifyContent:'center',alignItems:"center",marginBottom:"18px",height:"30%",width:"35%",flexDirection:"column",border:"1px solid #ccc",borderRadius:"6px",padding:"30px",textAlign:'center',marginLeft:isMobile?"20px":"100px",marginTop:isMobile?"300px":"50px"}}>
