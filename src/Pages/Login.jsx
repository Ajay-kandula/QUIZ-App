...
const Login =()=>{
    ...
    return( 
        <div  style={{display: "flex",flexDirection: "column",alignItems: 'flex-end',justifyContent: 'flex-end',height:"100vh",width:"100%",backgroundImage:`url(${loginBg})`,backgroundSize:'cover',backgroundPosition:"center",paddingRight:"60px"}} >
            <h1 style={{font: "initial",fontWeight: 'bold',fontSize: "60px",textAlign: "center"}}>Login form</h1>
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: 'column',alignItems: 'center',border: "1px solid #ccc",borderRadius: "7px",padding: "16px",width: "400px",height:"400px"}}>
