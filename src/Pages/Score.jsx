...
const Scorepage=()=>{
    ...
    return(
      ...
      backgroundImage: `url("https://i.ibb.co/4wKbbgFf/Whats-App-Image-2025-07-23-at-16-24-29-a29f0fb2-compressed.webp")`,backgroundPosition:"center",backgroundSize:"cover",display:"flex",flexDirection:"column",justifyContent:"center",height:"100vh",width:"100vw",alignItems:"center",gap:"4px"}}>
            <div style={{display:"flex",flexDirection:"column",justifyContent:'center',height:isMobile?"50%":"70%",width:isMobile?"90%":"45%",border:"2px solid black",borderRadius:"8px",alignItems:"center",marginTop:"40px"}}>
                ...
                <p style={{marginTop:isMobile?"20px":"40px",marginBottom:"20px"}}>You want to review the answers ? <button onClick={handlechange} style={{color:"white",backgroundColor:"#2a52be",padding:"3px",width:"80px"}}>Review</button></p>
            </div>
        </div>
    )
}
